...
const projects = [
  {
    ...
    description:
      'An IoT-powered system for comprehensive soil analysis and intelligent crop recommendations. Features real-time sensor integration, data processing, and actionable insights for precision agriculture.',
